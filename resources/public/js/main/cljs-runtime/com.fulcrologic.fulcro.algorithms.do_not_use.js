...
var vec__43101 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
...
var expr__$1 = (function (){var G__43131 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__43131);
} else {
return G__43131;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__43134 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__43134) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__43134));
} else {
return expr;
...
var len__5766__auto___43173 = arguments.length;
var i__5767__auto___43174 = (0);
while(true){
if((i__5767__auto___43174 < len__5766__auto___43173)){
args__5772__auto__.push((arguments[i__5767__auto___43174]));

var G__43175 = (i__5767__auto___43174 + (1));
i__5767__auto___43174 = G__43175;
continue;
} else {
}
break;
...
return com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$core$IFn$_invoke$arity$variadic(argseq__5773__auto__);
});
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq43148){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq43148));
}));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = (s instanceof cljs.core.Keyword);
...
var and__5041__auto____$1 = query;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__43172 = query;
var G__43172__$1 = (((G__43172 == null))?null:cljs.core.meta(G__43172));
var G__43172__$2 = (((G__43172__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__43172__$1));
if((G__43172__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__43172__$2) : component_name_fn.call(null,G__43172__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,1031812420,null);
} else {
}
