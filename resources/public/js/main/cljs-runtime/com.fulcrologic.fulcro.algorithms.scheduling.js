...
var map__45292 = app__$1;
var map__45292__$1 = cljs.core.__destructure_map(map__45292);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45292__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var raf_45298 = (((typeof requestAnimationFrame !== 'undefined'))?requestAnimationFrame:(function (p1__45295_SHARP_){
return com.fulcrologic.fulcro.algorithms.scheduling.defer(p1__45295_SHARP_,(16));
}));
/**
...
var map__45296 = app__$1;
var map__45296__$1 = cljs.core.__destructure_map(map__45296);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45296__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(runtime_atom),scheduled_key))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(runtime_atom,cljs.core.assoc,scheduled_key,true);
...
return (raf_45298.cljs$core$IFn$_invoke$arity$1 ? raf_45298.cljs$core$IFn$_invoke$arity$1(f) : raf_45298.call(null,f));
}
});
