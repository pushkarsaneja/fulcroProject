...
com.fulcrologic.guardrails.impl.externs.record_defn_BANG_ = (function com$fulcrologic$guardrails$impl$externs$record_defn_BANG_(NS,p__35529,externs){
var map__35530 = p__35529;
var map__35530__$1 = cljs.core.__destructure_map(map__35530);
var function$ = map__35530__$1;
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35530__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","fn-name","com.fulcrologic.guardrails.registry/fn-name",-1837692103));
...
com.fulcrologic.guardrails.impl.externs.register_external_function_BANG_ = (function com$fulcrologic$guardrails$impl$externs$register_external_function_BANG_(p__35531){
var map__35532 = p__35531;
var map__35532__$1 = cljs.core.__destructure_map(map__35532);
var external_function = map__35532__$1;
var var_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35532__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","var-name","com.fulcrologic.guardrails.registry/var-name",502701799));
...
var or__5043__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(com.fulcrologic.guardrails.impl.externs.external_function_registry),qualified_symbol);
...
var map__35533 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(info,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("com.fulcrologic.guardrails.registry","arities","com.fulcrologic.guardrails.registry/arities",1446074922),((has_arity_QMARK_)?arity:new cljs.core.Keyword(null,"n","n",562130025)),new cljs.core.Keyword("com.fulcrologic.guardrails.registry","gspec","com.fulcrologic.guardrails.registry/gspec",207045467),new cljs.core.Keyword("com.fulcrologic.guardrails.registry","metadata","com.fulcrologic.guardrails.registry/metadata",-1389979282)], null));
var map__35533__$1 = cljs.core.__destructure_map(map__35533);
var pure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35533__$1,new cljs.core.Keyword(null,"pure","pure",1433370394));
var pure_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35533__$1,new cljs.core.Keyword(null,"pure?","pure?",350862691));
var or__5043__auto__ = pure;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return pure_QMARK_;
...
var map__35534 = com.fulcrologic.guardrails.impl.externs.function_info(qualified_symbol);
var map__35534__$1 = cljs.core.__destructure_map(map__35534);
var info = map__35534__$1;
var spec_system = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35534__$1,new cljs.core.Keyword("com.fulcrologic.guardrails.registry","spec-system","com.fulcrologic.guardrails.registry/spec-system",-484591590));
if(cljs.core.truth_(info)){
var or__5043__auto__ = spec_system;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
