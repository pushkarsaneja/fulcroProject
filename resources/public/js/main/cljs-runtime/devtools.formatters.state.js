...
var len__5766__auto___28931 = arguments.length;
var i__5767__auto___28932 = (0);
while(true){
if((i__5767__auto___28932 < len__5766__auto___28931)){
args__5772__auto__.push((arguments[i__5767__auto___28932]));

var G__28933 = (i__5767__auto___28932 + (1));
i__5767__auto___28932 = G__28933;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq28861){
var G__28862 = cljs.core.first(seq28861);
var seq28861__$1 = cljs.core.next(seq28861);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28862,seq28861__$1);
}));
...
return cljs.core.some((function (p1__28869_SHARP_){
return (p1__28869_SHARP_ === object);
}),history__$1);
});
...
var _STAR_ = (function (p__28884){
var vec__28885 = p__28884;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28885,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28885,(1),null);
if((k === val)){
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.map_QMARK_(history);
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.map_QMARK_(parent_object);
if(and__5041__auto__){
...
if(cljs.core.truth_((function (){var and__5041__auto__ = cljs.core.map_QMARK_(devtools.formatters.state.get_second_last_object_from_current_history());
if(and__5041__auto__){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5043__auto__ = path_info;
