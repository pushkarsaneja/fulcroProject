...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__33254){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__33258){
...
var vec__33262 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33262,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33262,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__33265 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33265,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__33265;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__33266){
var map__33267 = p__33266;
var map__33267__$1 = cljs.core.__destructure_map(map__33267);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33267__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__33269){
var map__33270 = p__33269;
var map__33270__$1 = cljs.core.__destructure_map(map__33270);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33270__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__33271 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33271,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33271,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__33268_SHARP_){
var G__33274 = p1__33268_SHARP_;
var G__33275 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__33274,G__33275) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__33274,G__33275));
}));
} else {
