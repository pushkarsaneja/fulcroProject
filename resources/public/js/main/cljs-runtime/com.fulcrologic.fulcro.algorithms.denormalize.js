 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__43221){
var vec__43222 = p__43221;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43222,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43222,(1),null);
var ref = vec__43222;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__43227){
var vec__43228 = p__43227;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(1),null);
var ref = vec__43228;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__43233){
var map__43234 = p__43233;
var map__43234__$1 = cljs.core.__destructure_map(map__43234);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43234__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5751__auto__ = (function (){var and__5041__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__43239,entity,state_map,parent_node,idents_seen){
var map__43240 = p__43239;
var map__43240__$1 = cljs.core.__destructure_map(map__43240);
var join_node = map__43240__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = recursive_QMARK_;
if(and__5041__auto__){
return join_entity;
} else {
return and__5041__auto__;
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__43244,entity,state_map,idents_seen){
var map__43245 = p__43244;
var map__43245__$1 = cljs.core.__destructure_map(map__43245);
var join_node = map__43245__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43245__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__43247){
var map__43248 = p__43247;
var map__43248__$1 = cljs.core.__destructure_map(map__43248);
var node = map__43248__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43248__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5751__auto__ = (function (){var and__5041__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__5041__auto__){
...
var vec__43249 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43249,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__43252 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__43252) : union_key__GT_query.call(null,G__43252));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__43253,current_entity,state_map,idents_seen){
var map__43254 = p__43253;
var map__43254__$1 = cljs.core.__destructure_map(map__43254);
var top_node = map__43254__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43254__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43254__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
var wildcard_QMARK_ = (function (){var and__5041__auto__ = nil_nodes;
if(cljs.core.truth_(and__5041__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__43255 = nil_nodes;
var G__43255__$1 = (((G__43255 == null))?null:cljs.core.first(G__43255));
if((G__43255__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__43255__$1);
}
})());
} else {
return and__5041__auto__;
...
var G__43256 = result_node__$1;
var G__43256__$1 = (((G__43256 == null))?null:cljs.core.persistent_BANG_(G__43256));
if((G__43256__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43256__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43257 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__43257 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__43257,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__43258 = props;
var G__43258__$1 = (((G__43258 == null))?null:cljs.core.meta(G__43258));
if((G__43258__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__43258__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__43259 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__43260 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__43260);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__43259);
}});
/**
...
var map__43261 = cljs.core.meta(prior_props);
var map__43261__$1 = cljs.core.__destructure_map(map__43261);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43261__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43261__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
