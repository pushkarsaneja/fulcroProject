...
var or__5043__auto__ = document.getElementById(id);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var G__45260 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__45260,"id",id);

goog.dom.appendChild(document.body,G__45260);
...
var G__45261 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__45261,"id",id);

goog.dom.appendChild(document.body,G__45261);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45262_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__45262_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__45262_SHARP_,"__reactFiber$")));
...
var instance = (function (){var or__5043__auto__ = com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.getValueByKeys(raw,"_currentElement","_owner","_instance");
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__45263){
var map__45264 = p__45263;
var map__45264__$1 = cljs.core.__destructure_map(map__45264);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45264__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__45265 = target__$1;
if((G__45265 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__45265);
}
})();
...
var G__45274 = goog.dom.getParentElement(target__$1);
target__$1 = G__45274;
continue;
}
} else {
...
var G__45266_45275 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__45266_45275) : on_pick.call(null,G__45266_45275));
...
var state_map = (function (){var G__45267 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__45267__$1 = (((G__45267 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__45267));
if((G__45267__$1 == null)){
return null;
} else {
return cljs.core.deref(G__45267__$1);
}
})();
...
}catch (e45268){var _ = e45268;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__45270 = comp;
var G__45270__$1 = (((G__45270 == null))?null:com.fulcrologic.fulcro.components.react_type(G__45270));
if((G__45270__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__45270__$1);
}
}catch (e45269){var _ = e45269;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__45272 = comp;
var G__45272__$1 = (((G__45272 == null))?null:com.fulcrologic.fulcro.components.react_type(G__45272));
if((G__45272__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__45272__$1,state_map);
}
}catch (e45271){var _ = e45271;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45273__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
