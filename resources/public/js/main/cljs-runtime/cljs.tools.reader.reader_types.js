...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_31915 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_31915(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_31917 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_31917(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31922 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31922(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31926 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31926(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31928 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31928(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_31932 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_31932(reader);
}
});
...
var G__32020 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__32021 = s.append(c);
c = G__32020;
s = G__32021;
continue;
}
