...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29185){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29186,G__29187,seq29185__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29217_SHARP_){
return (!((cljs.core.meta(p1__29217_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29233__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29234){var _e__28337__auto__ = e29234;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e29236){var _e__28337__auto__ = e29236;
return false;
}}
})())){
...
var _STAR_current_state_STAR__temp_val__29246 = devtools.formatters.state.get_current_state();
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29247__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5751__auto___29314 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___29314)){
var managed_print_level_29317 = temp__5751__auto___29314;
var _STAR_print_level_STAR__orig_val__29253_29318 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29254_29319 = managed_print_level_29317;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29254_29319);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29251_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29251_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29253_29318);
}} else {
job_fn();
}
