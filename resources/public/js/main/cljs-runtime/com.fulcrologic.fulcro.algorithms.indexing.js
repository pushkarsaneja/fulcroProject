...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__46546){
var map__46547 = p__46546;
var map__46547__$1 = cljs.core.__destructure_map(map__46547);
var ast = map__46547__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46547__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46547__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__46552){
var map__46554 = p__46552;
var map__46554__$1 = cljs.core.__destructure_map(map__46554);
var child_ast = map__46554__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46554__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46554__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46554__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__46557 = idx;
var G__46557__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__46557,dispatch_key,parent_key):G__46557);
var G__46557__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__46557__$1,key,parent_key):G__46557__$1);
var G__46557__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__46557__$2,key,parent_key):G__46557__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__46557__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__46557__$3,child_ast));
} else {
return G__46557__$3;
}
...
var map__46572 = ast;
var map__46572__$1 = cljs.core.__destructure_map(map__46572);
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46572__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__46587){
var map__46588 = p__46587;
var map__46588__$1 = cljs.core.__destructure_map(map__46588);
var ast = map__46588__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46588__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46588__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-953214839,null);

var map__46607 = app__$1;
var map__46607__$1 = cljs.core.__destructure_map(map__46607);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46607__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46607__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__46608 = cljs.core.deref(runtime_atom);
var map__46608__$1 = cljs.core.__destructure_map(map__46608);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46608__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__46615 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__46615__$1 = cljs.core.__destructure_map(map__46615);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46615__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
if(cljs.core.truth_((function (){var and__5041__auto__ = ident;
...
var map__46637 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__46637__$1 = cljs.core.__destructure_map(map__46637);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46637__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__46641){
var map__46642 = p__46641;
var map__46642__$1 = cljs.core.__destructure_map(map__46642);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46642__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__46647_46684 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__46648_46685 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__46648_46685);
...
}),null)),null,1838891776,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__46647_46684);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__46651 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__46652 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__46652);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__46651);
}})], null);
}));
